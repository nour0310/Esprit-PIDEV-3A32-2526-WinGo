...
public class SupportController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            if (Utils.Session.getCurrentUser() != null) {
                // Profile info and Admin status are now handled by NavbarController
            }
            ...
            System.out.println("âœ… SupportController initialisÃ©");
    ...
    private void setupFormulaires() {
        ...
        if (recTypeBox != null) {
            recTypeBox.setItems(FXCollections.observableArrayList(
                    "GÃ©nÃ©ral", "Service", "Transport", "HÃ©bergement", "Restauration", "Technique", "Facturation",
                    "Autre"));
        }
    ...
    private void setupTables() {
        ...
        if (recColDate != null) {
            recColDate.setCellValueFactory(c -> new SimpleStringProperty(
                    c.getValue().getDate_reclamation() != null ? c.getValue().getDate_reclamation().toString() : "â€”"));
        }
        if (recColReponse != null) {
            recColReponse.setCellValueFactory(c -> new SimpleStringProperty(
                    c.getValue().getReponse_admin() != null ? c.getValue().getReponse_admin() : "â€”"));
        }
        ...
        if (sugColDate != null) {
            sugColDate.setCellValueFactory(c -> new SimpleStringProperty(
                    c.getValue().getDate_suggestion() != null ? c.getValue().getDate_suggestion().toString() : "â€”"));
        }
        if (sugColReclamationLien != null) {
            sugColReclamationLien.setCellValueFactory(c -> new SimpleStringProperty(
                    c.getValue().getId_reclamation() != null ? "#" + c.getValue().getId_reclamation() : "â€”"));
        }
    ...
    private void loadReclamations() {
        ...
        if (recResultCountLabel != null)
            recResultCountLabel.setText(list.size() + " rÃ©clamation(s)");
    }
    ...
    private void updateStats() {
        ...
        long resolues = recs.stream().filter(r -> "RÃ©solue".equals(r.getStatut())).count();
    ...
    // Profile and admin status handled by NavbarController
    ...
    private void showReclamationsTab() {
        ...
        if (mainSubtitle != null)
            mainSubtitle.setText("GÃ©rez les rÃ©clamations des clients");
        updateInfoCardForReclamations();
        loadReclamations();
    }
    ...
    private void showSuggestionsTab() {
        ...
        if (mainSubtitle != null)
            mainSubtitle.setText("Collectez et gÃ©rez les idÃ©es d'amÃ©lioration");
        updateInfoCardForSuggestions();
        loadSuggestions();
    }
    ...
    private void showStatsTab() {
        ...
        if (mainSubtitle != null)
            mainSubtitle.setText("Analyse en temps rÃ©el de l'activitÃ© support");
        updateStats();
    ...
    private void updateInfoCardForReclamations() {
        if (infoCardTitle != null)
            infoCardTitle.setText("RÃ©clamation en cours");
        ...
        if (selected != null) {
            ...
            if (quickProgress != null)
                quickProgress.setProgress("RÃ©solue".equals(selected.getStatut()) ? 1.0
                        : "En cours".equals(selected.getStatut()) ? 0.5 : 0.2);
            if (infoCardFooter != null)
                infoCardFooter.setText("PrioritÃ©: " + selected.getPriorite());
        } else {
            if (infoCardContent != null)
                infoCardContent.setText("SÃ©lectionnez une rÃ©clamation");
            if (quickProgress != null)
                quickProgress.setProgress(0);
            if (infoCardFooter != null)
                infoCardFooter.setText("Statistiques en temps rÃ©el");
        }
    }
    ...
    private void updateInfoCardForSuggestions() {
        ...
        if (selected != null) {
            if (infoCardContent != null)
                infoCardContent.setText(selected.getSujet() + "\nCatÃ©gorie: " + selected.getCategorie());
            if (quickProgress != null)
            ...
            if (infoCardContent != null)
                infoCardContent.setText("SÃ©lectionnez une suggestion");
            if (quickProgress != null)
                quickProgress.setProgress(0);
            if (infoCardFooter != null)
                infoCardFooter.setText("Partagez vos idÃ©es !");
        }
    }

    private void updateInfoCardForStats() {
        if (infoCardTitle != null)
            infoCardTitle.setText("Taux de rÃ©solution");
        List<Reclamation> recs = reclamationCRUD.afficherTous();
        long total = recs.size();
        long resolues = recs.stream().filter(r -> "RÃ©solue".equals(r.getStatut())).count();
        double taux = total > 0 ? (double) resolues / total : 0;
        if (infoCardContent != null)
            infoCardContent.setText(String.format("%d rÃ©clamations rÃ©solues sur %d", resolues, total));
        if (quickProgress != null)
    ...
    @FXML
    private void goToBlogs(javafx.event.ActionEvent event) {
        loadPage("/Blogs.fxml");
    }

    @FXML
    private void goToSupport(javafx.event.ActionEvent event) {
        // Already on support
    }
