...
public class RatingCRUD {
    ...
    // Ajouter ou mettre à jour une note (unique par utilisateur/article)
    ...
    // Récupérer la note d'un utilisateur pour un article
    ...
    // Récupérer toutes les notes (pour chargement initial)
