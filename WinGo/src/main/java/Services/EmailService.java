...
public class EmailService {
    ...
    public void envoyerCodeVerification(String toEmail, String code) {
        String subject = "WinGo - Code de vÃ©rification";
    ...
    private void sendEmail(String toEmail, String subject, String content) {
        ...
        try {
            ...
            System.out.println("Email envoyÃ© avec succÃ¨s Ã  " + toEmail);
    ...
    public boolean envoyerConfirmationReclamation(Reclamation r, String email, String nom) {
        System.out.println("Simulation: Email de confirmation envoyÃ© Ã  " + email);
        return true;
    }

    public boolean envoyerReponseReclamation(Reclamation r, String email, String nom) {
        System.out.println("Simulation: Notification de rÃ©ponse envoyÃ©e Ã  " + email);
        return true;
    }
    ...
    public void notifierAdminNouvelleReclamation(Reclamation r) {
        System.out.println("Simulation: Admin notifiÃ©");
    }
}
