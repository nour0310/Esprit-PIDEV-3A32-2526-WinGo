...
public class BlogCRUD {
        ...
        try (PreparedStatement pst = conn.prepareStatement(req, Statement.RETURN_GENERATED_KEYS)) {
            ...
            try (ResultSet generatedKeys = pst.getGeneratedKeys()) {
                if (generatedKeys.next()) {
                    ...
                    System.out.println("ID g̩n̩r̩ pour l'article : " + blog.getId());
                } else {
                    throw new SQLException("Cr̩ation d'article ̩chou̩e, aucun ID obtenu.");
                }
            }
        }
        System.out.println("Blog ajout̩ avec ID : " + blog.getId());
    }
    ...
    public void modifier(Blog blog) throws SQLException {
        ...
        System.out.println("Blog modifi̩ !");
    }
    ...
    public void supprimer(int id) throws SQLException {
        ...
        System.out.println("Blog supprim̩ !");
    }
    ...
    public List<Blog> afficher() throws SQLException {
        ...
        if (!articles.isEmpty()) {
            ...
            try (PreparedStatement pst = conn.prepareStatement(reqTags)) {
                ...
                System.err.println("Note : table article_tag peut-̻tre absente, aucun tag charg̩.");
            }
        }
