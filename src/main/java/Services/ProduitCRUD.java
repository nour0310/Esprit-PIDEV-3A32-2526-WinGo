...
public class ProduitCRUD implements IntrefaceCRUD<Produit> {
    ...
    public void ajouter(Produit produit) throws SQLException {
        ...
        try (PreparedStatement pst = conn.prepareStatement(req)) {
            ...
            pst.setString(3, produit.getDescription()); // null ok
            pst.setDouble(4, produit.getPrix());
            pst.setString(5, produit.getRegion());      // null ok
            pst.setString(6, produit.getCategorie());   // null ok
            pst.setInt(7, produit.getStock());
            pst.setString(8, produit.getImage());       // null ok
    ...
    // ✅ BONUS: afficher seulement les produits d’un vendeur (id_user)
